...
func NewContainerRuntime(runtimeService cri.RuntimeService, runtimeName string) *ContainerRuntime {
...
func (m *ContainerRuntime) podSandboxChanged(pod *v1.Pod, podStatus *kubecontainer.PodStatus) (bool, uint32, string) {
	return true, 0, ""
}
